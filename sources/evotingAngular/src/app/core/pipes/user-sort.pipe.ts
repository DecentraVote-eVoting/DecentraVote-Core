...
export class UserSortPipe implements PipeTransform {
  ...
  userSort(v1, v2, type, method): number {
    switch (type) {
      ...
      case 1: {
        if (v1.result.name1.localeCompare(v2.result.name1) < 0) { return -1; }
        if (v1.result.name1.localeCompare(v2.result.name1) > 0) { return 1; }

        if (v1.result.name2.localeCompare(v2.result.name2) < 0) { return -1; }
        if (v1.result.name2.localeCompare(v2.result.name2) > 0) { return 1; }

        if (v1.result.uid.localeCompare(v2.result.uid) < 0) { return -1; }
        if (v1.result.uid.localeCompare(v2.result.uid) > 0) { return 1; }
        break;
      }
      ...
      case 2: {
        ...
        if (v1.resolvedClaim.name1.localeCompare(v2.resolvedClaim.name1) < 0) { return -1; }
        if (v1.resolvedClaim.name1.localeCompare(v2.resolvedClaim.name1) > 0) { return 1; }

        if (v1.resolvedClaim.name2.localeCompare(v2.resolvedClaim.name2) < 0) { return -1; }
        if (v1.resolvedClaim.name2.localeCompare(v2.resolvedClaim.name2) > 0) { return 1; }

        if (v1.resolvedClaim.uid.localeCompare(v2.resolvedClaim.uid) < 0) { return -1; }
        if (v1.resolvedClaim.uid.localeCompare(v2.resolvedClaim.uid) > 0) { return 1; }
        break;
      }
      case 3: {
      ...
      case 4: {
        if (v1.name1.localeCompare(v2.name1) < 0) { return -1; }
        if (v1.name1.localeCompare(v2.name1) > 0) { return 1; }

        if (v1.name2.localeCompare(v2.name2) < 0) { return -1; }
        if (v1.name2.localeCompare(v2.name2) > 0) { return 1; }

        if (v1.uid.localeCompare(v2.uid) < 0) { return -1; }
        if (v1.uid.localeCompare(v2.uid) > 0) { return 1; }
      }
    }
    return 0;

...
export class CoreEffects {
  ...
  @Effect()
  readonly loadStorageUrls$: Observable<Action> = this.actions$.pipe(
  ...
  @Effect()
  readonly loadBallotBoxUrls$: Observable<Action> = this.actions$.pipe(
  ...
  @Effect()
  readonly notification$: Observable<Action> = this.actions$.pipe(
  ...
  @Effect()
  readonly getAuthOptions$: Observable<Action> = this.actions$.pipe(

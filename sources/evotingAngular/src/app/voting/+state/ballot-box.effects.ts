...
export class BallotBoxEffects {
  ...
  readonly getBallotsFromService$: Observable<Action> = createEffect(() => {
  ...
  readonly getBallotBoxFromStorage$: Observable<Action> = createEffect(() =>
    this.actions$.pipe(
  ...
  readonly getBallotsSuccess$: Observable<Action> = createEffect(() =>
    this.actions$.pipe(
